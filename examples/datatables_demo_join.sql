...
DROP TABLE IF EXISTS `datatables_demo_join`;
DROP TABLE IF EXISTS `datatables_demo_join_salary`;

CREATE TABLE `datatables_demo_join` (
...
CREATE TABLE `datatables_demo_join_salary` (
	`id`         int(10) NOT NULL,
	`salary`     int(8),
	PRIMARY KEY  (`id`)
);

INSERT INTO `datatables_demo_join`
...
INSERT INTO `datatables_demo_join_salary`
		( id, salary )
	VALUES
(1, 320800),
(2, 170750),
